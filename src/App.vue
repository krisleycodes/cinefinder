<template>
  <div class="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white font-sans">
    <div class="">
      <header class="bg-gray-900/80 backdrop-blur-lg shadow-lg py-6 sticky top-0 z-10 border-b border-gray-800/50">
        <div class="container screen mx-auto px-4 sm:px-6 flex items-center justify-between">
          <div>
            <h1
              class="text-3xl font-extrabold bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text">
              CineFinder</h1>
    ...
    <footer class="py-8">
      <div class="container mx-auto screen  px-4 sm:px-6">
        <hr class="border-gray-800 py-2"/>
        <p class="text-gray-400 text-center">Created with 💖 by Krisleycodes</p>
      </div>
    </footer>
  </div>
</template>
